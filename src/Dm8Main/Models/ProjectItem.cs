        ...
        {            
            ...
            switch (type)
            {
                ...
                case Types.StagingEntity:
                    return new ProjectItem(solutionService, eventAggregator, name, Types.StagingEntity, PathHelper.Combine(solutionService.Solution.StagingFolderPath, relPath), relPath);
                ...
                case Types.RawSubFolder:
                    return new ProjectItem(solutionService, eventAggregator, name, type, PathHelper.Combine(solutionService.Solution.RawFolderPath, relPath), relPath);
                ...
                case Types.GenerateSubFolder:
                    return new ProjectItem(solutionService, eventAggregator, name, type, PathHelper.Combine(solutionService.Solution.GenerateFolderPath, relPath), relPath);
