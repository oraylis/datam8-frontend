         ...
         try
         {
            ...
            if (dsCheck is IDm8PluginConnectorSourceExplorerV1 ds)
            {
               ...
               foreach (var entry in items)
               {
                  ...
                  // serialize object
                  string folderName = Path.Combine(this.solution.RawFolderPath ,checkedEntity.Entity.DataProduct ,checkedEntity.Entity.DataModule);
            ...
            if (dsCheck is IDataSourceExplorer ds1)
            {
               ...
               var newEntries = rc.Where(e => this.solutionService.SolutionHelper.GetFileName(e.Entity.Dm8l) == null && e.Entity.Dm8l != null);
