...
namespace Dm8Main.Views.Dialog
{
   ...
   /// </summary>
   public partial class DlgCoreEntityEditRelationship:MetroWindow, IClosableWindow
   {
      ...
      public DlgCoreEntityEditRelationshipViewModel ViewModel => (this.DataContext as DlgCoreEntityEditRelationshipViewModel)!;

      public DlgCoreEntityEditRelationship()
      {
         this.InitializeComponent();
         DialogServiceViews.SetIsRegistered(this ,true);
         this.RestoreState(Properties.Settings.Default.DlgCoreEntityEditRelationshipSettings);
      }
      ...
      {
         Properties.Settings.Default.DlgCoreEntityEditRelationshipSettings = this.StoreState();
